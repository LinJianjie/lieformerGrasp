...
_build = "lib/python3.6/site-packages/cubic_feature_sampling-1.1.0-py3.6-linux-x86_64.egg/"
_path = os.path.join(os.path.join(os.path.dirname(__file__)),
                     "../../../extensions_build/cubic_feature_sampling",
                     _build)
