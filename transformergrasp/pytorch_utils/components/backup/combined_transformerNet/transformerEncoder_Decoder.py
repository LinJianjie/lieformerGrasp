...
class ResidualConnection(nn.Module):
    ...
    def __init__(self, layernorm_size, dropout):
        ...
        self.norm = nn.BatchNorm1d(layernorm_size)
...
class Encoder(nn.Module):
    ...
    def __init__(self, input_linear_transform, encode_layer, N):
        ...
        self.norm = nn.BatchNorm1d(encode_layer.d_model)
...
class EncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, d_ff=1024, num_heads=8, dropout=0.3, local_attention_size=None,
                 make_future=False):
