...
import components.combined_transformerNet.t_constant
...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, d_model, d_ff, dropout=0.4):
        ...
        self.w_1 = nn.Conv1d(d_model, d_ff, kernel_size=1, bias=False)
        self.w_2 = nn.Conv1d(d_ff, d_model, kernel_size=1, bias=False)
...
class Embeddings(nn.Module):
    def __init__(self, vocab, d_model, use_cmlp=False):
        ...
        if use_cmlp:
            ...
            self.pn = NetUtil.SeqPointNetConv1d([3, 64, d_model])
