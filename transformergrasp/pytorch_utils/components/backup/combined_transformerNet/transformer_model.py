...
from components.combined_transformerNet.attention_module import *
from components.combined_transformerNet.transformerEncoder_Decoder import *
...
class NetTEncoder(nn.Module):
    def __init__(self, src_vocab, local_attention_size, N=6, d_model=512, d_ff=1024, num_head=8, dropout=0.1,
        ...
        self.pn_layers = CPointNetLinear([d_model * (N + 1), 256, 512, 1024])
